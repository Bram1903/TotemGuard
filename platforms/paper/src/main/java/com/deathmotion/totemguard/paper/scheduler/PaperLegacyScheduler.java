...
final class PaperLegacyScheduler implements PaperScheduler {

    private final Plugin plugin;
    private final BukkitScheduler scheduler;

    PaperLegacyScheduler(@NotNull Plugin plugin) {
        this.plugin = plugin;
    ...
    public ScheduledTask runAsyncTaskDelayed(Runnable task, long delay, TimeUnit timeUnit) {
        ...
        BukkitTask paperTask = scheduler.runTaskLaterAsynchronously(plugin, task, ticks);
