...
public class ApiEnabledEventTest implements Listener {
    private final ApiTestPlugin plugin;

    public ApiEnabledEventTest(ApiTestPlugin plugin) {
        this.plugin = plugin;
    }

    @EventHandler
    public void onApiEnable(ApiEnabledEvent event) {
        plugin.getLogger().info("API enabled!");
    }
}
