...
final class PluginHost implements TGPluginHost {
    ...
    PluginHost(Platform platform, Object nativePlugin, Logger logger, Path dataFolder,
               ClassLoader hostClassLoader, LoaderController loaderController) {
    ...
    @Override
    public @NotNull Optional<LoaderController> loaderController() {
        return Optional.ofNullable(loaderController);
    }
