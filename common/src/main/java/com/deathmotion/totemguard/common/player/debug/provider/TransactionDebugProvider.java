...
public final class TransactionDebugProvider implements DebugOverlayProvider {
    ...
    public DebugOverlayFrame buildFrame(TGPlayer player) {
        ...
        Component line = Component.empty()
                ...
                .append(separator())
                .append(label("+ "))
                .append(value(String.valueOf(pingData.getLastSentPositiveTransactionId()), NamedTextColor.WHITE))
                .append(separator())
                .append(label("Reply "))
                .append(value(replyStatus(pingData), replyColor(pingData)))
                .append(separator())
                .append(label("TPQ "))
                .append(value(String.valueOf(pingData.getPendingTeleportCount()), countColor(pingData.getPendingTeleportCount())))
                .append(separator())
                .append(label("TP "))
