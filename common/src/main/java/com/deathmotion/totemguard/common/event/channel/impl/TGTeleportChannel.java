...
import com.deathmotion.totemguard.api.event.events.TGTeleportEvent;
...
public final class TGTeleportChannel extends EventChannelImpl<TGTeleportEvent> {

    public TGTeleportChannel() {
        super(TGTeleportEvent.class);
    }

    public boolean fire(@NotNull UUID callerUuid, @NotNull UUID targetUuid,
        ...
        Holder event = new Holder(callerUuid, targetUuid, targetName, targetUser,
                targetServerInstanceId, targetServerName, crossServer);
        dispatch(event);
        return event.cancelled;
    }

    private static final class Holder implements TGTeleportEvent {
        ...
        Holder(UUID callerUuid, UUID targetUuid, String targetName, @Nullable TGUser targetUser,
               UUID targetServerInstanceId, String targetServerName, boolean crossServer) {
