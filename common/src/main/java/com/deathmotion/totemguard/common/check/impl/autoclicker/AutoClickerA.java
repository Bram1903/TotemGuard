...
public class AutoClickerA extends CheckImpl implements PacketCheck {
    ...
    public AutoClickerA(TGPlayer player) {
        super(player);
    }
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        ClickData clickData = player.getClickData();
        if (!clickData.isCpsUpdated()) return;

        int leftClicksPerSecond = clickData.getLeftClicksPerSecond();
