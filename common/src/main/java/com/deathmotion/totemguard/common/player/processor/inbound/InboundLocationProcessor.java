...
public class InboundLocationProcessor extends ProcessorInbound {

    public InboundLocationProcessor(TGPlayer player) {
        super(player);
    }
    ...
    public void handleInbound(PacketReceiveEvent event) {
        if (WrapperPlayClientPlayerFlying.isFlying(event.getPacketType())) {
            ...
            player.getLocation().setLocation(flying.getLocation());
        }
    }
}