...
@Getter
public final class TGUserFlagEventImpl extends TGUserEventImpl implements TGUserFlagEvent {
    ...
    public TGUserFlagEventImpl(TGUser user, Check check, String debug) {
        super(user);
        this.check = check;
        this.debug = debug;
