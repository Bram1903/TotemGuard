...
import com.deathmotion.totemguard.common.diagnostic.RedisDiagnosticsListener;
...
final class TotemGuardLifecycle {
    ...
    static void enable(TGPlatform p) {
        ...
        p.clusterService = new ClusterServiceImpl(p.redisRepository, serverIdentity.instanceId(), p.getLogger());
        ...
        p.diagnosticService = new DiagnosticService(p);
        p.redisRepository.addStateListener(new RedisDiagnosticsListener(p.diagnosticService));
