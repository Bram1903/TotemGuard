...
public final class PistonWindow {
    ...
    private static final double PISTON_PUSH_CLAMP = 0.51;
    ...
    public boolean apply(AreaBounds bounds) {
        ...
        bounds.expandRadius(PISTON_PUSH_CLAMP * Math.sqrt(2.0));
        bounds.ceiling(bounds.ceiling() + PISTON_PUSH_CLAMP);
        bounds.addDescentSlack(PISTON_PUSH_CLAMP);
        return true;
    }
}
