...
public final class SyncCheckResultHandler implements PacketProcessor<SyncCheckResultPacket.Payload>, Reloadable {

    private final TGPlatform platform;
    private final RedisRepositoryImpl redisRepository;
    private final PacketRegistry registry;
    private final Packet<SyncCheckResultPacket.Payload> packet;

    public SyncCheckResultHandler(TGPlatform platform, RedisRepositoryImpl redisRepository, PacketRegistry registry) {
        this.platform = platform;
        this.redisRepository = redisRepository;
        this.registry = registry;
        this.packet = Packets.SYNC_CHECK_RESULT.packet();
    }

    @Override
    public void handle(SyncCheckResultPacket.Payload payload) {
        platform.handleIncomingCheckResult(payload);
    }
