...
public final class TraceFrame {
    ...
    public static final int FLAG_SUPPORT_ENTITY = 1 << 28;
    ...
    public double entRenderX, entRenderY, entRenderZ;
    public double entTargetX, entTargetY, entTargetZ;
    public double entSpanMinX, entSpanMaxX, entSpanMinZ, entSpanMaxZ;
    public double entHalfWidth, entHeight;
    public double entPlyMinX, entPlyMaxX, entPlyMinZ, entPlyMaxZ;
    public int entSteps;
    ...
    public void copyFrom(TraceFrame other) {
        ...
        entTracked = other.entTracked;
        entRenderX = other.entRenderX;
        entRenderY = other.entRenderY;
        entRenderZ = other.entRenderZ;
        entTargetX = other.entTargetX;
        entTargetY = other.entTargetY;
        entTargetZ = other.entTargetZ;
        entSpanMinX = other.entSpanMinX;
        entSpanMaxX = other.entSpanMaxX;
        entSpanMinZ = other.entSpanMinZ;
        entSpanMaxZ = other.entSpanMaxZ;
        entHalfWidth = other.entHalfWidth;
        entHeight = other.entHeight;
        entPlyMinX = other.entPlyMinX;
        entPlyMaxX = other.entPlyMaxX;
        entPlyMinZ = other.entPlyMinZ;
        entPlyMaxZ = other.entPlyMaxZ;
        entSteps = other.entSteps;
