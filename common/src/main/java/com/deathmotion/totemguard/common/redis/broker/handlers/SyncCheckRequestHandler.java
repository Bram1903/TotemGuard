...
public final class SyncCheckRequestHandler implements PacketProcessor<SyncCheckRequestPacket.Payload>, Reloadable {

    private final TGPlatform platform;
    private final RedisRepositoryImpl redisRepository;
    private final PacketRegistry registry;
    private final Packet<SyncCheckRequestPacket.Payload> packet;

    public SyncCheckRequestHandler(TGPlatform platform, RedisRepositoryImpl redisRepository, PacketRegistry registry) {
        this.platform = platform;
        this.redisRepository = redisRepository;
        this.registry = registry;
        this.packet = Packets.SYNC_CHECK_REQUEST.packet();
    }

    @Override
    public void handle(SyncCheckRequestPacket.Payload payload) {
        platform.handleIncomingCheckRequest(payload);
    }
