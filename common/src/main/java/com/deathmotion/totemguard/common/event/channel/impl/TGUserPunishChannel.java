...
import com.deathmotion.totemguard.api.event.events.TGUserPunishEvent;
import com.deathmotion.totemguard.api.user.TGUser;
import com.deathmotion.totemguard.common.event.channel.EventChannelImpl;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

public final class TGUserPunishChannel extends EventChannelImpl<TGUserPunishEvent> {

    public TGUserPunishChannel() {
        super(TGUserPunishEvent.class);
    }
    ...
    private static final class Holder implements TGUserPunishEvent {
