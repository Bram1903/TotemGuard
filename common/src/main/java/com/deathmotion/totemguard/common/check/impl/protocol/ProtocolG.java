...
@RequiresTickEnd
@CheckData(description = "Sprinting without forward input", type = CheckType.PROTOCOL, experimental = true)
public class ProtocolG extends CheckImpl implements PacketCheck {
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if (data.isInVehicle() || data.isSwimming() || data.isFlying()) return;

        InputData.State input = inputData.current();
