...
public final class BoatBody implements SimulationBody {

    private final BoatFloatModel floatModel = new BoatFloatModel();
    ...
    public BoatFloatModel floatModel() {
        return floatModel;
    }
}
