...
@Getter
public final class TGFollowEventImpl extends EventImpl implements TGFollowEvent {

    private final @NotNull UUID followerUuid;
    ...
    public TGFollowEventImpl(@NotNull UUID followerUuid, @NotNull UUID targetUuid,
