...
import com.deathmotion.totemguard.api.event.events.TGFollowEvent;
...
public final class TGFollowChannel extends EventChannelImpl<TGFollowEvent> {

    public TGFollowChannel() {
        super(TGFollowEvent.class);
    }

    public boolean fire(@NotNull UUID followerUuid, @NotNull UUID targetUuid,
        ...
        Holder event = new Holder(followerUuid, targetUuid, targetName, targetUser,
                targetServerInstanceId, targetServerName, crossServer, serverSwitch);
        dispatch(event);
        return event.cancelled;
    }

    private static final class Holder implements TGFollowEvent {
        ...
        Holder(UUID followerUuid, UUID targetUuid, String targetName, @Nullable TGUser targetUser,
        ...
        @Override
        public @NotNull UUID getFollowerUuid() {
            return followerUuid;
        }
