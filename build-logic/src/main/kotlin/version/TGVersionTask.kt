...
abstract class TGVersionTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val file = outputDir.file("$packagePath/TGVersions.java").get().asFile
        ...
        file.writeText(
            ...
            public final class TGVersions {
                ...
                public static final TGVersion CURRENT = new TGVersion(${parsedVersion.major}, ${parsedVersion.minor}, ${parsedVersion.patch}, ${parsedVersion.quotedSnapshotCommit()});
