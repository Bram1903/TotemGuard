...
abstract class TGVersionTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val file = dir.file("TGVersions.java").asFile
        if (!file.exists()) {
            file.createNewFile()
        }

        val ver = Version.fromString(version)
        logger.info("Generating TGVersions.java with version $ver")
        ...
        file.writeText(
            ...
            public final class TGVersions {
                ...
                public static final TGVersion CURRENT = new TGVersion(${ver.major}, ${ver.minor}, ${ver.patch}, ${ver.quotedSnapshotCommit()});
